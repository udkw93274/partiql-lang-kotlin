...
internal fun createBuiltinFunctions(valueFactory: ExprValueFactory) =
    listOf(
        ...
        SignExprFunction(valueFactory),
        CeilExprFunction(valueFactory),
        FloorExprFunction(valueFactory),
        RoundExprFunction(valueFactory),
        TruncExprFunction(valueFactory),
        ModExprFunction(valueFactory),
        ...
        BitORExprFunction(valueFactory), 
        BitANDExprFunction(valueFactory), 
        BitXORExprFunction(valueFactory), 
        SinExprFunction(valueFactory),        
        SinhExprFunction(valueFactory), 
        CosExprFunction(valueFactory), 
        CoshExprFunction(valueFactory), 
        TanExprFunction(valueFactory), 
        TanhExprFunction(valueFactory), 
        AsinExprFunction(valueFactory), 
        AcosExprFunction(valueFactory), 
        AtanExprFunction(valueFactory), 
        AtanhExprFunction(valueFactory), 
        Atan2ExprFunction(valueFactory), 
        ...
        RegexpReplaceExprFunction(valueFactory),
        RegexpMatchesExprFunction(valueFactory),
        RegexpSubstrExprFunction(valueFactory),
        ConcatExprFunction(valueFactory),
        FlatListExprFunction(valueFactory),
        ListExprFunction(valueFactory),
        NumbytesExprFunction(valueFactory),
        NewuuidExprFunction(valueFactory),
        LeadingPadExprFunction(valueFactory),
        TrailingPadExprFunction(valueFactory),
        ChrExprFunction(valueFactory),
        GetItemExprFunction(valueFactory),
        EncodeExprFunction(valueFactory),
        DecodeExprFunction(valueFactory),
        HashExprFunction(valueFactory),
